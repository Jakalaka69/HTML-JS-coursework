function addImages(){
    let imageSection = document.getElementById("imageSource");
    imageSection.innerHTML = '<img class="image2" align=right src="chapter1.PNG"/>'
   
}
addImages()


function chaptar1(response){
    let section = document.getElementById("chap1i");
    let count = 0
